...
def scan(code):
    ...
    data = [
        ...
        ('merchantId', '10001954'),
        ('serverVersion', '1'),
        ('sign', 'e3505dffec86f2edeb85e733d3a330d0'),
        ('storeId', '10041657'),
        ('telephone', '18368388086'),
        ('uid', '477459'),
        ('username', '%E5%BE%90%E5%BD%A9%E5%A8%87'),
        ('version', '47'),
    ]
    ...
    data1 = [
        ...
        ('deviceId', '184d19d52857d3628276407b946e367d208c7c5d'),
        ('loginToken', 'a53428ebb6498b446258e01d16d3f02d'),
        ('memberId', '15000000376836564'),
        ('merchantId', '10001954'),
        ('serverVersion', '1'),
        ('sign', '5240b564c8ef6baed7a59770b7e993c3'),
        ('storeId', '10041657'),
        ('telephone', '18368388086'),
        ('uid', '477459'),
        ('userId', '477459'),
