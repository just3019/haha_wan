...
def scan(code):
    ...
    data = [
        ...
        ('merchantId', '10063409'),
        ('serverVersion', '1'),
        ('sign', '796f9eddd90063fdf0c821ff013b5c0b'),
        ('storeId', '10113678'),
        ('telephone', '15010442033'),
        ('uid', '385248'),
        ('username', '%E5%8D%95%E8%8A%B7%E8%96%87'),
        ('version', '47'),
    ]
    ...
    data1 = [
        ...
        ('deviceId', '184d19d52857d3628276407b946e367d208c7c5d'),
        ('loginToken', '9d8b89cc8b8049c459f104b983275d73'),
        ('memberId', '15000000378997295'),
        ('merchantId', '10063409'),
        ('serverVersion', '1'),
        ('sign', '66feba50e6fca3eb7e2f6496e81e4683'),
        ('storeId', '10113678'),
        ('telephone', '15010442033'),
        ('uid', '385248'),
        ('userId', '385248'),
