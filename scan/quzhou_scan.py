...
def scan(code):
    params = (
        ...
        ('_uni_source', '2.2'),
        ('merchantId', '10100097'),
        ('loginToken', 'e0eddba60eacbcd7b33b42c3e4169383'),
        ('deviceId', '184d19d52857d3628276407b946e367d208c7c5d'),
        ('appType', 'bpMobile'),
        ('username', '17755625017'),
        ('serverVersion', '1'),
        ('clientAgent', 'iPhone9,2/iOS/11.4.1/1242*2208'),
        ('telephone', '17755625017'),
    )

    data = [
        ('_uni_source', '2.2'),
        ('appType', 'bpMobile'),
        ('app_time', '135289749123'),
        ...
        ('merchantId', '10100097'),
        ('serverVersion', '1'),
        ('sign', '1e1d2422b36530f65b5e620facdb3c54'),
        ('storeId', '10412157'),
        ('telephone', '17755625017'),
        ('uid', '457291'),
        ('username', '17755625017'),
    ...
    data1 = [
        ...
        ('deviceId', '184d19d52857d3628276407b946e367d208c7c5d'),
        ('loginToken', 'e0eddba60eacbcd7b33b42c3e4169383'),
        ('memberId', '15000000373126605'),
        ('merchantId', '10100097'),
        ('serverVersion', '1'),
        ('sign', '132da43d5c8926623c1165992bc46d5e'),
        ('storeId', '10412157'),
        ('telephone', '17755625017'),
        ('uid', '457291'),
        ('userId', '457291'),
