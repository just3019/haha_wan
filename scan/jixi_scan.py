...
def scan(code):
    params = (
        ...
        ('_uni_source', '2.2'),
        ('merchantId', '10077248'),
        ('loginToken', '995ddec55cfd751216ddda196973ccec'),
    ...
    data = [
        ...
        ('merchantId', '10077248'),
        ('serverVersion', '1'),
        ('sign', '922c43decdce3c5c96bdf1f85f09a78b'),
        ('storeId', '10249638'),
        ('telephone', '18888888888'),
        ('uid', '403504'),
    ...
    data1 = [
        ...
        ('deviceId', '184d19d52857d3628276407b946e367d208c7c5d'),
        ('loginToken', '995ddec55cfd751216ddda196973ccec'),
        ('memberId', '15000000377683416'),
        ('merchantId', '10077248'),
        ('serverVersion', '1'),
        ('sign', 'c8178c66477bfd6c89f591d45b187764'),
        ('storeId', '10249638'),
        ('telephone', '18888888888'),
        ('uid', '403504'),
        ('userId', '403504'),
