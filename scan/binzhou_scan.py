...
def scan(code):
    params = (
        ...
        ('_uni_source', '2.2'),
        ('merchantId', '10100594'),
        ('loginToken', 'eaf29569bd3b59622c14a9bd06cc7410'),
    ...
    data = [
        ...
        ('merchantId', '10100594'),
        ('serverVersion', '1'),
        ('sign', '7684f1aded038095c8cc437efee1b128'),
        ('storeId', '10414030'),
        ('telephone', '13511111234'),
        ('uid', '476312'),
    ...
    data1 = [
        ...
        ('deviceId', '184d19d52857d3628276407b946e367d208c7c5d'),
        ('loginToken', 'eaf29569bd3b59622c14a9bd06cc7410'),
        ('memberId', '15000000132925208'),
        ('merchantId', '10100594'),
        ('serverVersion', '1'),
        ('sign', '0e7e7c31add95f577bf6ab60040ba50c'),
        ('storeId', '10414030'),
        ('telephone', '13511111234'),
        ('uid', '476312'),
        ('userId', '476312'),
