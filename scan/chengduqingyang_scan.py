...
def scan(code):
    ...
    data = [
        ...
        ('merchantId', '10103151'),
        ('serverVersion', '1'),
        ('sign', 'f7b38c2d8ccd4491d26e22343e41eefd'),
        ('storeId', '10421109'),
        ('telephone', '18502863337'),
        ('uid', '467630'),
        ('username', '%E5%B8%82%E5%9C%BA%E6%8E%A8%E5%B9%BF%E9%83%A8'),
        ('version', '47'),
    ]
    ...
    data1 = [
        ...
        ('deviceId', '184d19d52857d3628276407b946e367d208c7c5d'),
        ('loginToken', '29f7988807fbdf297f8a42850ebfe5ad'),
        ('memberId', '15000000377178763'),
        ('merchantId', '10103151'),
        ('serverVersion', '1'),
        ('sign', 'fb030a5c0e0a618d7e0d533a26dea7d4'),
        ('storeId', '10421109'),
        ('telephone', '18502863337'),
        ('uid', '467630'),
        ('userId', '467630'),
