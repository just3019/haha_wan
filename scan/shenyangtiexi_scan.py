...
def scan(code):
    params = (
        ...
        ('_uni_source', '2.2'),
        ('merchantId', '10048071'),
        ('loginToken', 'd90ce66cb49cef83ffc7b8424cfeee1b'),
    ...
    data = [
        ...
        ('merchantId', '10048071'),
        ('serverVersion', '1'),
        ('sign', 'e909ec52c077912248ef986d03c1005a'),
        ('storeId', '2063999'),
        ('telephone', '13390148110'),
        ('uid', '483430'),
    ...
    data1 = [
        ...
        ('deviceId', '184d19d52857d3628276407b946e367d208c7c5d'),
        ('loginToken', 'd90ce66cb49cef83ffc7b8424cfeee1b'),
        ('memberId', '15000000374157390'),
        ('merchantId', '10048071'),
        ('serverVersion', '1'),
        ('sign', 'fcf95374b7d4a9764c89c390cda140be'),
        ('storeId', '2063999'),
        ('telephone', '13390148110'),
        ('uid', '483430'),
        ('userId', '483430'),
