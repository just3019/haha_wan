...
def scan(code):
    ...
    data = [
        ...
        ('merchantId', '10018275'),
        ('serverVersion', '1'),
        ('sign', '819d4ee0612020a2c2a84c640df78136'),
        ('storeId', '2072451'),
        ('telephone', '15825297775'),
        ('uid', '275262'),
        ('username', '%E4%BB%98%E5%BC%BA'),
        ('version', '47'),
    ]
    ...
    data1 = [
        ...
        ('deviceId', '184d19d52857d3628276407b946e367d208c7c5d'),
        ('loginToken', '64facfa44cb2accc64408fe1250a680d'),
        ('memberId', '15000000308194833'),
        ('merchantId', '10018275'),
        ('serverVersion', '1'),
        ('sign', '88a089504cb28003bab8d5f8f680a023'),
        ('storeId', '2072451'),
        ('telephone', '15825297775'),
        ('uid', '275262'),
        ('userId', '275262'),
