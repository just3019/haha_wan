...
def scan(code):
    params = (
        ...
        ('_uni_source', '2.2'),
        ('merchantId', '10106628'),
        ('loginToken', '3e6b3bd30080b1baabc4f87452cf5410'),
        ('deviceId', '184d19d52857d3628276407b946e367d208c7c5d'),
        ('appType', 'bpMobile'),
        ('username', '13846177589'),
        ('serverVersion', '1'),
        ('clientAgent', 'iPhone9,2/iOS/11.4.1/1242*2208'),
        ('telephone', '13846177589'),
    )

    data = [
        ('_uni_source', '2.2'),
        ('appType', 'bpMobile'),
        ('app_time', '155043394383'),
        ...
        ('merchantId', '10106628'),
        ('serverVersion', '1'),
        ('sign', 'f7c47cb57ef0ae511135d34fc338c887'),
        ('storeId', '10425295'),
        ('telephone', '13846177589'),
        ('uid', '471605'),
        ('username', '13846177589'),
    ...
    data1 = [
        ...
        ('deviceId', '184d19d52857d3628276407b946e367d208c7c5d'),
        ('loginToken', '3e6b3bd30080b1baabc4f87452cf5410'),
        ('memberId', '15000000374643337'),
        ('merchantId', '10106628'),
        ('serverVersion', '1'),
        ('sign', '233ff19103f65b32ff7ca0eb8fa12401'),
        ('storeId', '10425295'),
        ('telephone', '13846177589'),
        ('uid', '471605'),
        ('userId', '471605'),
...
def deal():
    ...
    while True:
        try:
            ...
            write(mystr)
            log(str(index) + "个核销成功。")
            sleeptime = random.randint(10, 180)
