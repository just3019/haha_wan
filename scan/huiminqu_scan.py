...
def scan(code):
    params = (
        ...
        ('_uni_source', '2.2'),
        ('merchantId', '10109157'),
        ('loginToken', '309bb8ec485b7e4d68834ce763027612'),
        ('deviceId', '184d19d52857d3628276407b946e367d208c7c5d'),
        ('appType', 'bpMobile'),
        ('username', '13488573914'),
        ('serverVersion', '1'),
        ('clientAgent', 'iPhone9,2/iOS/11.4.1/1242*2208'),
        ('telephone', '13488573914'),
    )

    data = [
        ('_uni_source', '2.2'),
        ('appType', 'bpMobile'),
        ('app_time', '2485342583551'),
        ...
        ('merchantId', '10109157'),
        ('serverVersion', '1'),
        ('sign', '8b53001cefbf364aa66acefeec9586c2'),
        ('storeId', '10428018'),
        ('telephone', '13488573914'),
        ('uid', '476460'),
        ('username', '13488573914'),
    ...
    data1 = [
        ...
        ('deviceId', '184d19d52857d3628276407b946e367d208c7c5d'),
        ('loginToken', '309bb8ec485b7e4d68834ce763027612'),
        ('memberId', '15000000377865655'),
        ('merchantId', '10109157'),
        ('serverVersion', '1'),
        ('sign', '528377a22ce585fb0cadbadc70fbe73a'),
        ('storeId', '10428018'),
        ('telephone', '13488573914'),
        ('uid', '476460'),
        ('userId', '476460'),
